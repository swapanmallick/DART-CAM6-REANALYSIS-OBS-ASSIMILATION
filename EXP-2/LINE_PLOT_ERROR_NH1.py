...
plt.text(15, 3.8, 'REGION (NORTHERN HEMISPHERE)',fontweight='bold',fontstyle='italic',horizontalalignment='center',verticalalignment='center',rotation='horizontal', color="black")
...
#
plt.xlim(0,30)
##plt.ylim(np.min(E_PR)-0.5,np.max(E_PR)+0.5)
...
#-----------------------------------------------
##plt.show()
plt.savefig('AA1_LINE_ERROR_NH.png')
