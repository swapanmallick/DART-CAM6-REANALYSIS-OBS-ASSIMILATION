...
plt.text(15, 3.8, 'REGION (TROPICS)',fontweight='bold',fontstyle='italic',horizontalalignment='center',verticalalignment='center',rotation='horizontal', color="black")
...
#-----------------------------------------------
##plt.show()
plt.savefig('AA1_LINE_ERROR_EQ.png')
